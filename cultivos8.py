...
class AppCultivos(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("Asistente de Cultivos (Tema Oscuro)")
    ...
    def crear_widgets(self):
        ...
        # Fechas (Usando el color de énfasis verde)
        ...
        frame_precios = ttk.Frame(frame_agregar, style='TLabelframe') # Usar estilo de marco secundario
        ...
        # Botones de lista
        frame_botones_lista = ttk.Frame(frame_mostrar, style='TLabel') # Usar estilo simple de frame
    ...
    def mostrar_calendario(self, campo_destino):
        ...
        # Toplevel usa el tema por defecto de la librería, pero se verá bien
    ...
    def revisar_cosechas_al_inicio(self):
        ...
        if cosechas_listas:
            ...
            # Usar estilo base Tlabel, pero asegurar que el foreground sea claro
